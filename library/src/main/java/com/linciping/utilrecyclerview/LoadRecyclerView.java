...
public class LoadRecyclerView extends RecyclerView {
    ...
    public static abstract class LoadAdapter<VH extends RecyclerView.ViewHolder>
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == NORMAL_HOLDER) {
                ...
                if (mLoadView != null) {
                    ...
                    View loadView = LayoutInflater.from(parent.getContext()).inflate(com.linciping.utilrecyclerview.R.layout.item_load, parent, false);
        ...
        private boolean isFooter(int position) {
            if (getItemCount() - 1 <= position && mCanLoad) {
                return true;
            } else {
                return false;
            }
